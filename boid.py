...
class Boid:
    ...
    def seek(self, target):
        ...
        if dist < 100:
            #zmanjsa svojo hitrost sorazmerno z razdaljo
    ...
    def wander(self):
        ...
        #smer v krogu v katero se zeli obrniti
        self.wander_theta += random.uniform(-change, change)
        #tocka pred boidom za center kroga tavanja
        circle_center = self.velocity.normalize() * wander_distance
        #za nakljucno tocko na obodu
    ...
    def separate(self, boids):
        ...
        #ignorira samega sebe
        for other in boids:
            if other is self:
                continue
            
            #samo tiste ki so v vidnem kotu
            ...
            if 0 < d < desired_separation:
                ...
                if diff.length() != 0:
                    diff = diff.normalize() # za smer
                steer += diff / d #vecja teza za blizje boide
                count += 1
                
        if count > 0:
            steer /= count #povpreci da uposteva vse zaznane bliznje
    ...
    def align(self, boids):
        ...
        for other in boids:
            ...
            if 0 < d < neighbor_dist:
                ...
                count += 1
        if count > 0:
            avg_vel /= count #povrepcna hitrost
    ...
    def follow_flow_field(self):
        factor = 0.01 #gostota vzorca
        #za ustvarjanje spremenljivega kota 
